...
llvm::raw_fd_ostream _log_file(_log_fileName.str().c_str(), _log_ErrorInfo, sys::fs::F_Text);
...
/// around. And the class ConstantRange allows that. So, I'm writing this class to
...
class InterProceduralRACropDFS: public RangeAnalysis {
    public:
        InterProceduralRACropDFS() { CG = NULL; }
        ~InterProceduralRACropDFS();
...
class IntraProceduralRACropDFS: public  RangeAnalysis {
    public:
        IntraProceduralRACropDFS() { CG = NULL; /*errs() << "\nIntraProceduralRA ctor";*/ }
        ~IntraProceduralRACropDFS();
...
class InterProceduralRACousot: public RangeAnalysis {
    public:
        InterProceduralRACousot() { CG = NULL; }
        ~InterProceduralRACousot();
        bool runOnModule(Module &M);
        static unsigned getMaxBitWidth(Module &M);
...
class IntraProceduralRACousot: public  RangeAnalysis {
    public:
        IntraProceduralRACousot() { CG = NULL; /*errs() << "\nIntraProceduralRA ctor";*/ }
        ~IntraProceduralRACousot();
        bool runOnFunction(Function &F);
