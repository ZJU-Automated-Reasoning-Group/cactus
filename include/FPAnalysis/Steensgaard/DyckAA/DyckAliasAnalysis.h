...
#include "FPAnalysis/Steensgaard/DyckGraph/DyckGraph.h"
...
namespace Steensgaard{
    ...
    public:
        ...
        void performDyckAliasAnalysis(Module&);

        void collectThreadEscapedObjects(Module &M);

        std::map<CallInst*,std::set<llvm::Function*>> getCanaryFunctionPointerResult(){
            return this->icall_result;
        };

        std::set<Value*> getFunctionPointerRelatedVal(){
            return this->fp_related_values;
        }
    ...
    private:
        ...
        std::map<CallInst*,std::set<llvm::Function*>> icall_result;

        std::set<Value*> fp_related_values;

        void collectFPInfoFromDyckGraph(Module & M);
    ...
    public:
        ...
        std::set<Value*> collectSteensgaardCluster(Value* calledValue);
