...
bool DyckGraph::qirunAlgorithm() {
    ...
    while (!worklist.empty()) {
        ...
        fp_realted_vals.insert(z_i_it->second);
...
std::set<void*> DyckGraph::getFPResultValueSet(){
//    std::set<void*> fpRelatedValSet;
//    for(auto it=fp_related_vertices.begin();it!=fp_related_vertices.end();it++){
//        DyckVertex* dyckVer=*it;
//        for(auto it2=val_ver_map.begin();it2!=val_ver_map.end();it2++){
//            if((it2->second)==dyckVer){
//                fpRelatedValSet.insert(it2->first);
//            }
//        }
//    }
    return fp_realted_vals;
}
