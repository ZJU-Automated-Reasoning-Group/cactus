...
#include "SRAA/StrictRelationAliasAnalysis.h"
...
StrictRelations::alias(const AliasAnalysis::Location &LocA, const AliasAnalysis::Location &LocB) {
  NumQueries++;
  const Value *p1, *p2;
  p1 = LocA.Ptr;
  p2 = LocB.Ptr;
